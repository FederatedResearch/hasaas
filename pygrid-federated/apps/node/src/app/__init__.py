...
def create_app(node_id: str, debug=True, n_replica=None, test_config=None) -> Flask:
    ...
    JOBS = [
        {
            'id': 'cycle_expiration',
            'func': 'src.app.main.routes.model_centric.routes:check_cycle_expiration',
            'trigger': 'interval',
            'seconds': 10,  # call the task function every 3 seconds
    ...
    # app.config['UPLOAD_FOLDER'] = '/home/mustansar/Mustansar/Softwares/private-repositories/pygrid-federated/apps/node/src/app/files'
    app.config['UPLOAD_FOLDER'] = '/media/aliza16/34a93c51-067c-4a49-8db0-907586ac455c/home/aliza/Mustansar/Softwares/PyGrid/apps/node/src/app/files'
...
def create_lambda_app(node_id: str) -> FlaskLambda:
    ...
    return app
from .main.routes.model_centric.routes import scheduler