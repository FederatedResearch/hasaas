...
if __name__ == "__main__":
    ...
    if args.start_local_db:
        ...
        # db_path = "sqlite:////home/mustansar/Mustansar/Softwares/private-repositories/pygrid-federated/apps/node/src/app/databasenetwork.db"
        db_path = "sqlite:////media/aliza16/34a93c51-067c-4a49-8db0-907586ac455c/home/aliza/Mustansar/Softwares/private-repositories/pygrid-federated/apps/node/src/app/databasenetwork.db"
        app = create_app(
            node_id=args.id,
            debug=True,
