...
COLUMN_NAMES = [
    CLIENT_ID_KEY, 'client_type', NUM_ROUND_KEY, 'hierarchy', NUM_SAMPLES_KEY, 'set']
...
def print_metrics(
    ...
    mode = 'w' if (round_number == 0 or (metrics_name == 'metrics_sys' and round_number == 1)) else 'a'
