...
class FedDropServer:
    ...
    def train_model(self, num_epochs=1, batch_size=10, minibatch=None, clients=None, lr=-1, actorgrad=None):
        ...
        for c in clients:
            if c.type == 'H':
                c.model.set_params(self.model_high)
    ...
    def test_model(self, clients_to_test, set_to_use='test'):
        ...
        self.client_model_high.set_params(self.model_high)
        for client in clients_to_test:
            if client.type == 'H':
                client.model.set_params(self.model_high)
                c_metrics = client.test(set_to_use, self.client_model_high)
