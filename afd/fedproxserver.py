...
class FedProxServer:
    ...
    def train_model(self, i=0, num_epochs=1, batch_size=10, minibatch=None, clients_per_round=20, droprate=0.0):
        ...
        for c in clients:
            ...
            if c.type == 'H':
                ...
                comp, num_samples, update = c.train(np.random.randint(low=1, high=num_epochs), batch_size, minibatch)
