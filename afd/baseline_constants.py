...
MODEL_PARAMS = {
    ...
    'femnist.small_cnn': (0.0003, 62), # lr, num_classes
    'femnist_skewed.cnn': (0.0003, 62), # lr, num_classes
    'femnist_skewed.small_cnn': (0.0003, 62), # lr, num_classes
    ...
    'cifar.cnn': (0.0003, 10), # lr, num_classes
}
